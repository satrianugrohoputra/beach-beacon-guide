  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-amber-50 via-orange-50 to-white text-center p-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 animate-fade-in">
        ...
        <Link 
          to="/about"
          className="px-6 py-3 border-2 border-teal-400 text-teal-600 rounded-full hover:bg-teal-50 transition-all duration-300 transform hover:scale-105 font-medium"
        >
          Learn More
        </Link>
      </div>
